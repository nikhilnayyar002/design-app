...
@Component({
  selector: 'app-prak-dash-github-star-repo',
  templateUrl: './prak-dash-github-star-repo.component.html',
  styleUrls: ['./prak-dash-github-star-repo.component.css']
})
export class PrakDashGithubStarRepoComponent implements OnInit {
  ...
  headerLinks:HeaderLinks[] = [
    ...
    {image:"assets/icons/star_border-black.svg", label:"Starred Repositories", url:"./"},
  ];
  ...
  sidebarLinks:SidebarLinks[] = [
    ...
    {image:"assets/icons/star_border.svg", label:"Starred Repositories", url:"./", selected:true},
  ]
